...
def login():
    ...
    #notice the auth sub directory - would not be needed if blueprint used a template folder
...
def password_reset_request():
    ...
    if form.validate_on_submit():
        ...
        if user:
            ...
            send_email(user.email,"Reset Your Password","mail/reset_password", user=user, token=token, next=request.args.get('next'))
